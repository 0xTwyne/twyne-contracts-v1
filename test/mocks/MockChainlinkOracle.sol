...
import {BaseAdapter, Errors} from "euler-price-oracle/src/adapter/BaseAdapter.sol";
import {AggregatorV3Interface} from "euler-price-oracle/src/adapter/chainlink/AggregatorV3Interface.sol";
import {ScaleUtils, Scale} from "euler-price-oracle/src/lib/ScaleUtils.sol";

/// @title MockChainlinkOracle
/// @dev Removes staleness check
contract MockChainlinkOracle is BaseAdapter {
